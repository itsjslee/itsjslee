...
[![Languages and Tools](https://skillicons.dev/icons?i=arduino,bash,c,cpp,css,dart,fastapi,figma,firebase,flutter,git,html,java,js,latex,linux,matlab,nextjs,nodejs,npm,opencv,powershell,py,raspberrypi,react,shell,sklearn,swift,tailwind,ts&theme=dark)](https://v0-mildjosh.vercel.app/projects)
